...
#lightbox-img{max-width:100%;max-height:95vh;object-fit:contain;border-radius:10px;box-shadow:0 0 30px rgba(255,255,255,0.3);transition:transform 0.35s cubic-bezier(0.4,0,0.2,1);}
...
function closeLightbox() { lightbox.style.display = 'none'; img.style.transform = 'translateX(0)'; }
function updateImage() { if (allImages[currentIndex]) img.src = allImages[currentIndex].src; }
